...
| ----------------------------------------------------- | :------------------------------------------------: | ------------------------------------------------------------ |
| [pi](https://github.com/earendil-works/pi) [![GitHub stars](https://img.shields.io/github/stars/earendil-works/pi?style=flat&color=gold)](https://github.com/earendil-works/pi) | [#8743](https://github.com/earendil-works/pi/pull/8743) | [fix(coding-agent): ignore stale tool image conversions - #8743]() |
...
|  | [#4081](https://github.com/volcengine/OpenViking/pull/4081) | [fix(privacy): serialize config mutations under pathlock and propagate storage errors]() |
