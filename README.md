...
| Project                                                      | Stars | What it does                                                 |
| ------------------------------------------------------------ | :---: | ------------------------------------------------------------ |
| [RepoMirror](https://github.com/wutongyuonce/repo-mirror) |  70+  | 一个极简的 macOS 桌面工具，用于将 GitHub 仓库或其子目录镜像同步到本地文件夹树｜A minimal macOS desktop app for mirroring GitHub repositories or repository subdirectories into a local folder tree |
...
| [memU](https://github.com/NevaMind-AI/memU) (14.3k★) | [#660](https://github.com/NevaMind-AI/memU/pull/660) | [feat(claude-code): verify Cowork source composition]() |
...
| [OpenViking](https://github.com/volcengine/OpenViking) (29.4k★) | [#4083](https://github.com/volcengine/OpenViking/pull/4083) | [fix(ragfs): return config error instead of panicking when pathlock manager is missing](https://github.com/volcengine/OpenViking/commit/d88967aaeb969106ed3e77249bb3ef8248a03ebb) |
