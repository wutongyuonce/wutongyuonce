...
| ------------------------------------------------------------ | :---: | ------------------------------------------------------------ |
| [wutong-yu-blog](https://github.com/wutongyuonce/wutong-yu-blog) |  22+   | 🌐 一个精简的 Antfu 风格 Astro 博客主题｜A minimalistic Antfu-style Astro blog theme |

### Agent

| Project                                                      | Stars | What it does                                                 |
| ------------------------------------------------------------ | :---: | ------------------------------------------------------------ |
| [MODULAR-RAG-MCP](https://github.com/wutongyuonce/MODULAR-RAG-MCP) |  19+   | 一个可插拔可观测的模块化 RAG MCP 框架｜A pluggable and observable modular RAG MCP framework |
| [XingClaw](https://github.com/wutongyuonce/XingClaw)         |  42+  | 🤖 用 Python 从零搭建一个完整的 AI 编程助手系统：统一 LLM 调用 + Agent 编排内核 + 飞书 IM 桥接｜Building a Complete AI Programming Assistant System from Scratch with Python: Unified LLM Invocation + Agent Orchestration Kernel + Feishu IM Integration |
...
| ----------------------------------------------------- | :------------------------------------------------: | ------------------------------------------------------------ |
| [OpenKB](https://github.com/VectifyAI/OpenKB) (2.8k★) | [#59](https://github.com/VectifyAI/OpenKB/pull/59) | auto-propagate LLM_API_KEY to provider-specific env vars via config-driven detection |
| [OpenKB](https://github.com/VectifyAI/OpenKB) (2.8k★) | [#79](https://github.com/VectifyAI/OpenKB/pull/79) | Eliminate duplicate wiki-tool implementations in skill/tools.py |
